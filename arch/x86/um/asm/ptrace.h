...
/*
 * D3: HAVE_REGS_AND_STACK_ACCESS_API (KPROBE_EVENTS). um's kernel stack
 * is in-process host memory; PT_REGS_SP is the interrupted stack. Same
 * shape as x86's header inlines, on the um accessors.
 */
